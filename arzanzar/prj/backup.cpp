...
void* callApproxVC2(void *arg){
   ...
   // std::cout<<"Time diff in sec: "<<(endTime.tv_sec-startTime.tv_sec)<<std::endl;
    ...
    double time = (double)((endTime.tv_sec-startTime.tv_sec)*1000000) + (double)((endTime.tv_nsec/1000)-(startTime.tv_nsec/1000));
...
void threadCreation(){
    ...
    waitTime.tv_sec+=1.5;  //having wait time of 1 sec for this graph cnf-sat solver thread
